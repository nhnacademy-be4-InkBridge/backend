...
////        BooksPaginationReadResponseDto booksPaginationReadResponseDto = mock(
////            BooksPaginationReadResponseDto.class);
////        Page<BooksPaginationReadResponseDto> resultPage = new PageImpl<>(List.of(
////            booksPaginationReadResponseDto),
////            pageable, 0);
////
////        when(bookRepository.findAllBooks(any(Pageable.class))).thenReturn(resultPage);
////
////        Page<BooksPaginationReadResponseDto> page = bookService.readBooks(pageable);
////
...
//        List<BookStockUpdateRequestDto> bookStockUpdateRequestDtos = List.of(
//            BookStockUpdateRequestDto.builder()
//                .bookId(1L)
//                .stock(1)
//                .build());
//        when(bookRepository.findByBookIdIn(anyList())).thenReturn(List.of(mock(Book.class)));
//
//        bookService.updateStock(bookStockUpdateRequestDtos);
//
