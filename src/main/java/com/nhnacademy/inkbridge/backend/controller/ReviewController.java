...
public class ReviewController {
    ...
    public ResponseEntity<List<ReviewReadResponseDto>> getReviews(
        ...
        List<ReviewReadResponseDto> reviews = reviewService.getReviews(memberId);
    ...
    public ResponseEntity<HttpStatus> createReview(
        ...
        reviewService.createReview(reviewCreateRequestDto, files);
    ...
    public ResponseEntity<HttpStatus> updateReview(@PathVariable(name = "reviewId") Long reviewId,
        ...
        reviewService.updateReview(reviewId, reviewCreateRequestDto, files);
